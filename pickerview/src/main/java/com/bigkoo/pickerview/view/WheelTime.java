...
//                maxItem = endD;
     ...
     * @param font 系统提供的几种样式
     */
    public void setCenterTextTypeface(Typeface font) {
        wv_day.setCenterTypeFace(font);
        wv_month.setCenterTypeFace(font);
        wv_year.setCenterTypeFace(font);
        wv_hours.setCenterTypeFace(font);
        wv_minutes.setCenterTypeFace(font);
        wv_seconds.setCenterTypeFace(font);
    }
    ...
    public void setIsOpen3D(boolean isOpen3D) {
