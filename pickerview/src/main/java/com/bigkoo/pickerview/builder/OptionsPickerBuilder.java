...
public class OptionsPickerBuilder {
     ...
     * @return
     */
    public OptionsPickerBuilder setDividerWidth(float dividerWidth) {
    ...
    public OptionsPickerBuilder setCenterTypeface(Typeface font) {
        mPickerOptions.centerTypeface = font;
        return this;
    }
