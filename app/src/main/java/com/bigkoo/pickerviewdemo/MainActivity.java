...
import com.bigkoo.pickerview.utils.DensityUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_close_3d = (Button) findViewById(R.id.btn_close_3d);
        ...
        btn_close_3d.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        } else if (v.getId() == R.id.btn_close_3d) {
